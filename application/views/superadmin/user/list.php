                            ...
                            <tbody>
                                ...
                                foreach ($userb as $user) { ?>
                                    <tr>
                                        ...
                                        <td><?php if ($user->akses_level == 'superadmin') echo "Administrator Desa"; ?><?php if ($user->akses_level == 'admin_pkk') echo "Pengurus Desa"; ?><?php if ($user->akses_level == 'admin_desa') echo "Perangkat Desa"; ?></td>
                            ...
                            <form action="<?php echo site_url('superadmin/user/tambah') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="akses_level" class="form-control">
                                        ...
                                        <option value="superadmin">Administrator Desa</option>
                                    </select>
                                </div>
                                <!-- end -->
                                <!-- end -->

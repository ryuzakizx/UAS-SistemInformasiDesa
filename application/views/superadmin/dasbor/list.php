<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            ...
            <h1 class="mt-4">Dashboard <?php if ($this->session->userdata('akses_level') == 'superadmin') echo "Admin Desa";
            ...
            <?php if ($this->session->userdata('akses_level') == 'superadmin') { ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="card bg-secondary text-white mb-4">
                            <div class="card-body">
                                <h4><?php echo count($struktur) ?> Pengurus Desa</h4>
                            </div>
                            <div class="card-footer d-flex align-items-center justify-content-between">
                                <a class="small text-white stretched-link" href="<?php echo site_url('superadmin/struktur') ?>">Lihat Detail Pengurus Desa</a>
                                <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                            </div>
                        </div>
                    </div>

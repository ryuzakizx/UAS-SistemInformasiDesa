            ...
            <div class="row mb-4">
              <div class="col">
                <div class="input-group">
                  ...
                  <input type="text" value="<?php if ($userb->akses_level == 'superadmin') echo "Administrator Desa"; ?><?php if ($userb->akses_level == 'admin_pkk') echo "Pengurus Desa"; ?><?php if ($userb->akses_level == 'admin_desa') echo "Perangkat Desa"; ?> " class="form-control" placeholder="Username" disabled>
                </div>
              </div>
            </div>
